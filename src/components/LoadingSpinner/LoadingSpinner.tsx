...
export function LoadingSpinner() {
  return (
    ...
    >
      ...
      <path d="M25.0013 55.5C24.7645 42 55.5013 40.5 55.5013 22V9" stroke="white" strokeWidth="8" />
      <path d="M55.5 55.5C55.7369 42 25 40.5 25 22V9M24 69H25" stroke="white" strokeWidth="8" />
      <path
